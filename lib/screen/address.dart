...
class AddAccount extends StatefulWidget {
  final String pro_id5;
  final String name5;
  final String pro_price5;
  final String pro_qty5;
  final String pro_image5;
  final String total5;
  AddAccount(this.name5, this.pro_id5, this.pro_price5, this.pro_qty5,
      this.pro_image5, this.total5,
      {Key key})
      : super(key: key);
  @override
